...
class SDNDefenseApp(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.flow_monitor = FlowMonitor(flows_report_folder, watch_generated_flows, self.datapath_list, self.defense_managers)
    ...
    def _switch_features_handler(self, ev):
        ...
        self.flow_monitor._add_default_flow(datapath, 0, match, actions, flags=0)

        ofp_parser = datapath.ofproto_parser

        actions = []
        match1 = ofp_parser.OFPMatch(eth_type=0x86DD)  # IPv6
        self.flow_monitor._add_default_flow(datapath, 999, match1, actions, flags=0)
